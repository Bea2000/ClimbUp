...
import {
  ParticipantWithCompetitionInformation,
  ParticipantWithCompetitionAndProblems,
} from "@/types/participant";

import {
  getLastCompetitionForOrganizer,
  getParticipantsCountForCompetitionByCompetitionId,
} from "./competition";
...
export async function findParticipantWithCompetitionAndProblemsByIdAndCompetitionId(
  ...
  return {
    ...participant,
    competition: participant.competitions[0],
  } as ParticipantWithCompetitionAndProblems;
}
